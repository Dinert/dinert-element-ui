...
type RewriteColProps = Partial<InstanceType<typeof Col>>

type RewriteRowProps = Partial<InstanceType<typeof Row>>
type FormProps = InstanceType<typeof Form>
type FormItemProps = InstanceType<typeof FormItem>
